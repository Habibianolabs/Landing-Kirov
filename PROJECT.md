...
- секция «Партнёры программы» возвращена к исходной композиции: стандартный фон секции, обычные внешние карточки и одинаковые внутренние рамки вокруг обоих логотипов с фоном `var(--surface-muted)`; названия всех основных секций, включая «О проекте», оформлены одинаковыми центрированными liquid-glass web-плашками;
