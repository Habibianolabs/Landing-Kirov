...
const partnerData = {
  ...
  mamina: {
    ...
    html: `<h3>Описание компании</h3><p>Группа компаний «Мамина Кухня» — одна из крупнейших компаний общественного питания Кирова, успешно работающая на рынке более 22 лет.</p><p>За годы работы компания сформировала эффективную экосистему предприятий различных форматов, объединив собственное производство, рестораны и предприятия быстрого обслуживания в единую операционную модель.</p><p>Сегодня в структуру компании входят:</p><ul><li>3 кулинарии;</li><li>2 трактира;</li><li>2 ресторана;</li><li>1 бистро;</li><li>собственная фабрика-кухня площадью 1 500 м².</li></ul><p>Ключевым производственным активом компании является современная фабрика-кухня, которая обеспечивает централизованное изготовление продукции для собственной сети предприятий, корпоративных клиентов и проектов государственного заказа.</p><p>Производственная модель построена на современных технологиях организации пищевого производства, единых стандартах качества и строгом контроле всех этапов технологического процесса. Это позволяет поддерживать стабильно высокое качество продукции, эффективно управлять себестоимостью и обеспечивать бесперебойные поставки независимо от объема производства.</p><p>Все предприятия компании работают в рамках единой системы управления, используя общие производственные регламенты, стандарты сервиса, финансового контроля и операционного менеджмента. Такой подход обеспечивает устойчивость бизнеса, прозрачность процессов и возможность дальнейшего масштабирования сети.</p><h3>Ключевые проекты</h3><p>В портфель ресторанной компании входят предприятия различных форматов, ориентированные на разные категории гостей и потребности рынка.</p><p>Среди них:</p><ul><li>сеть кулинарий и кафе «Мамина Кухня», расположенных в различных районах Кирова;</li><li>трактир «Колесо»;</li><li>ресторан «Реберная. Еда на огне»;</li><li>бистро «Вареничная»;</li><li>ресторация «Царское село» — ресторан русской кухни, расположенный в историческом здании 1902 года и являющийся одной из гастрономических достопримечательностей города.</li></ul><p>Разнообразие концепций позволяет компании эффективно работать в различных ценовых сегментах, удовлетворяя потребности как повседневного, так и праздничного спроса.</p><h3>Развитие и достижения</h3><p>Более чем за два десятилетия работы «Мамина Кухня» стала одним из лидеров рынка общественного питания Кирова, создав устойчивую и масштабируемую бизнес-модель, основанную на диверсификации форматов, собственном производстве и эффективном операционном управлении.</p><p>Компания активно развивает корпоративное направление и успешно реализует проекты для государственных и коммерческих заказчиков.</p><p>Среди корпоративных партнеров компании:</p><ul><li>Сбербанк;</li><li>Т Плюс;</li><li>Лемана ПРО;</li><li>другие крупные федеральные компании.</li></ul><p>Опыт работы с корпоративными клиентами подтверждает высокий уровень производственной организации, способность выполнять крупные объемы заказов и соблюдать строгие требования к качеству продукции и срокам поставки.</p><h3>Ключевые преимущества компании</h3><ul><li>более 22 лет успешной работы на рынке общественного питания;</li><li>диверсифицированный портфель предприятий различных форматов;</li><li>собственная фабрика-кухня площадью 1 500 м²;</li><li>централизованная система производства и управления;</li><li>опыт реализации корпоративных и государственных контрактов;</li><li>единые стандарты качества и операционного управления;</li><li>высокая производственная эффективность и контроль бизнес-процессов;</li><li>устойчивый, масштабируемый ресторанный бизнес с потенциалом дальнейшего развития.</li></ul>`
  }
};
