...
function setupScrollReveal() {
  ...
  const revealGroups = [
    ...
    { selector: ".project-partner-card, .person-card, .price-card, .included-card, .testimonial-card", direction: "up", stagger: 70 },
...
const partnerData = {
  culture: {
    ...
    html: `<h3>Описание компании</h3><p>Одна из современных ресторанных компаний России с сильным операционным управлением и опытом масштабирования за пределы региона. Под управлением альянса 21 кафе и ресторан в пяти городах России: Кирове, Москве, Нижнем Новгороде, Сыктывкаре и Чебоксарах. В команде более 700 профессионалов. Выручка ресторанов альянса составляет порядка 1,5 млрд рублей.</p><h3>Ключевые проекты</h3><p>В портфель входят ресторан «Сулугуни», восточный ресторан «Куркума», Si, mare, кафе «Сушилка», кофейня «Искра», «Дача», «Джари», «Вкусноблин», бар-музей «Васи Ложкина», «Чико» в Нижнем Новгороде и другие проекты.</p><h3>Развитие и достижения</h3><p>Альянс одним из первых среди ресторанных компаний в России начал внедрять передовые технологические решения, автоматизировать бизнес-процессы и использовать искусственный интеллект в управлении.</p>`
  },
  mamina: {
    kicker: "Мамина кухня",
    title: "Сеть предприятий общественного питания",
    html: `<h3>Описание компании</h3><p>Сеть предприятий общественного питания, включающая рестораны, кафе и кулинарии. В портфеле компании заведения с глубокой исторической идентичностью и высоким уровнем сервиса.</p><h3>Ключевые проекты</h3><p>В структуру сети входят ресторация «Царское село», кулинарии и кафе «Мамина кухня», трактир «Колесо», «Реберная. Еда на огне» и бистро «Вареничная».</p><h3>Развитие и достижения</h3><p>Ресторация «Царское село» расположена в историческом здании 1902 года и считается визитной карточкой города.</p>`
  }
};
