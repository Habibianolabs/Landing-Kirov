...
- блок «Как проходят наши мероприятия» с тремя предоставленными фотографиями, lightbox и Rutube iframe, загрузка которого отложена до прокрутки;
...
- тарифы, состав участия, галерея, lightbox, отложенно загружаемый Rutube iframe, отзывы, cookie consent и footer;
